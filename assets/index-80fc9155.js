 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let L1,F1;function O3(n){L1=n}function M3(n){F1=n}class V3 extends ip{compare(e,t){const r=e.node.getPriority(),i=t.node.getPriority(),s=r.compareTo(i);return s===0?dl(e.name,t.name):s}isDefinedOn(e){return!e.getPriority().isEmpty()}indexedValueChanged(e,t){return!e.getPriority().equals(t.getPriority())}minPost(){return Qe.MIN}maxPost(){return new Qe(Po,new jt("[PRIORITY-POST]",F1))}makePost(e,t){const r=L1(e);return new Qe(t,new jt("[PRIORITY-POST]",r))}toString(){return".priority"}}const An=new V3;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qd(){return{value:null,children:new Map}}function U1(n,e,t){if(ze(e))n.value=t,n.children.clear();else if(n.value!==null)n.value=n.value.updateChild(e,t);else{const r=je(e);n.children.has(r)||n.children.set(r,Qd());const i=n.children.get(r);e=gt(e),U1(i,e,t)}}function Am(n,e,t){n.value!==null?t(e,n.value):Q3(n,(r,i)=>{const s=new yt(e.toString()+"/"+r);Am(i,s,t)})}function Q3(n,e){n.children.forEach((t,r)=>{e(r,t)})}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _A=10*1e3,J3=30*1e3,X3=5*60*1e3;class Z3{constructor(e,t){this.server_=t,this.statsToReport_={},this.statsListener_=new Y3(e);const r=_A+(J3-_A)*Math.random();dc(this.reportStats_.bind(this),Math.floor(r))}reportStats_(){const e=this.statsListener_.get(),t={};let r=!1;Tr(e,(i,s)=>{s>0&&qi(this.statsToReport_,i)&&(t[i]=s,r=!0)}),r&&this.server_.reportStats(t),dc(this.reportStats_.bind(this),Math.floor(Math.random()*2*X3))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
